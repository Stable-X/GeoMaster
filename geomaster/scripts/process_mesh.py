...
@click.option('--clean', default=False, type=bool, help='Whether to clean')
@click.option('--occ', default=False, type=bool, help='Whether to generate occ')
def main(model_path: str, output_path: str, sap_res: int, num_sample: int, sig: int = 2, refine: bool =False, clean: bool=False, occ: bool = False) -> None:
