# code borrowed from https://github.com/Profactor/continuous-remeshing/blob/main/core/opt.py and https://github.com/apple/ml-direct2.5/blob/main/meshing/opt.py
...
def gen_inputs(mesh_name, num_sample=-1):
    ...
    if num_sample > 0:
        ...
        vertices = torch.from_numpy(mesh.vertices * scale + center)
